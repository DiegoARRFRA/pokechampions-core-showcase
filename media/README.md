...
[Galería en español](../docs/GALLERY.md) · [English gallery](../docs/GALLERY.en.md)

## Español

Paquete preparado el **17 de septiembre de 2026** a partir de capturas y tres grabaciones de pantalla facilitadas por el autor. La interfaz capturada está en español y usa el tema oscuro. La versión exacta de la aplicación no se ha establecido de forma independiente a partir de estas grabaciones.

| Demo | Tramo de la grabación original | Pausa final añadida | Duración aproximada |
|---|---|---|---|
...
Las tres demos son tramos continuos: **no se aceleran las búsquedas ni se suprimen esperas dentro del tramo seleccionado**. Solo se añade una pausa sobre el último fotograma. El cambio de frecuencia de imagen reduce el número de fotogramas de las vistas previas, no acelera el recorrido.

Se recortan las barras de estado y navegación de Android, se elimina el audio y se redimensiona sin cambiar la proporción. No se generan interfaces, no se combinan varias vistas en una pantalla ficticia y no se retocan los datos ni los avisos de la aplicación.
...
Prepared on **17 September 2026** from screenshots and three screen recordings supplied by the author. The captured interface uses Spanish and the dark theme. The exact application build has not been independently established from these recordings.

Each demo is a continuous excerpt played at the original speed, with a short final-frame hold: Versus approximately 13 seconds, 1HITKO approximately 13 seconds, and Lead Trainer approximately 15 seconds. Search waiting time inside each selected excerpt is preserved. Lower preview frame rates do not speed up the recording.
